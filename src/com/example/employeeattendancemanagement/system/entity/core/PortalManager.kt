...
object PortalManager: EmployeeAssistance(), EmployeeActions by PortalManagerEmployeeService(employeeDB), EmployeeManagementActions by PortalManagerEmployeeManagementService(employeeDB), AuthenticatorActions by AuthenticatorService(employeeDB){
