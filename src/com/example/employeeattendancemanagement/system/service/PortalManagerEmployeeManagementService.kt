    ...
    : EmployeeManagementActions
{
    ...
    override fun addEmployee(admin: Admin, name: String, superiorId: Int, assistance: EmployeeAssistance): Boolean{
    ...
    override fun addASubOrdinateForAnEmployee(admin: Admin, id: Int, subordinateId: Int): Boolean {
    ...
    override fun setSuperiorForAnEmployee(admin: Admin, id: Int, superiorId: Int): Boolean {
    ...
    override fun viewEmployees(admin: Admin) {
